    ...
    <div className={styles.privacyPolicy}>
      <div>
        ...
        <p>
          ...
          предпринимаемые ИП Иванов Иваном Ивановичем (далее – Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          веб-сайта https://i-shop point.ru/.
        </p>
        ...
        <p>
          ...
          определенному или определяемому Пользователю веб-сайта https://i-shop point.ru/;
        </p>
        <p>2.9. Пользователь – любой посетитель веб-сайта https://i-shop point.ru/;</p>
        <p>
        ...
        <p>
          ...
          электронной почты apple.shop@point@mail.ru с пометкой «Отказ от уведомлений о новых
        ...
        <p>
          ...
          сайте https://i-shop point.ru/. Заполняя соответствующие формы и/или отправляя свои
        ...
        <p>
          ...
          электронной почты Оператора apple.shop@point@mail.ru с пометкой «Актуализация персональных
          данных».
        </p>
        <p>
          ...
          apple.shop@point@mail.ru с пометкой «Отзыв согласия на обработку персональных данных».
        </p>
