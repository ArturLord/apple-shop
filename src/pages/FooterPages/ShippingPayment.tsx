      ...
      <div className={styles.aboutContainer}>
        <div className={styles.shipping}>
          ...
          <div>
            ...
            <p>- Бесплатная доставка к нужному времени по Новосибирску и окрестностям</p>
        ...
        <div className={styles.payment}>
          ...
          <div>
            ...
            <div className={styles.paymentSale}>
              * При оплате наличными или с помощью перевода на карту предоставляется дополнительная
              скидка.
              <span>
                Почему так? Мы стараемся обеспечить для вас не только лучший сервис, но и
                максимально низкие цены, в связи с этим наша наценка для многих товаров меньше, чем
                комиссии, которые взимают банки. Поэтому мы ввели дополнительную скидку для способов
                оплаты, не имеющих комиссии.
              </span>
            </div>
          </div>
        </div>
